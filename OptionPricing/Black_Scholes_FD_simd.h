...
// Class for pricing options using Finite Difference method with SIMD optimization
...
private:
    ...
    std::vector<double> V, V_temp, k_temp, res, res_prev; // 1D arrays for option prices and temporary storage
    ...
    // Compute equation of motion for multiple grid points using SIMD
...
public:
    // Constructor to initialize model parameters and optional arrays
